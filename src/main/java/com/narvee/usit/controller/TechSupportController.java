...
public class TechSupportController {
	...
	public ResponseEntity<RestAPIResponse> AddTechSupport(@RequestBody TechAndSupport techandsupport) {
		...
		return new ResponseEntity<>(
				new RestAPIResponse("Success", "Technology Saved Successfully", Service.saveTechSupp(techandsupport)),
				HttpStatus.CREATED);
	}
	...
	public ResponseEntity<RestAPIResponse> all() {
		logger.info("TechSupportController.getAllbykeyword()");
		List<TechAndSupport> all = Service.all();
		System.out.println(all);
		return new ResponseEntity<>(new RestAPIResponse("Success", "Fetch TechSupport Details By Id", all),
				HttpStatus.OK);
	...
	public ResponseEntity<RestAPIResponse> updateTechsupoort(@RequestBody TechAndSupport techandsupport) {
		logger.info("TechSupportController.updateTechsupoort()");
		return new ResponseEntity<>(
				new RestAPIResponse("Success", "Record Updated Successfully", Service.saveTechSupp(techandsupport)),
				HttpStatus.OK);
	}
