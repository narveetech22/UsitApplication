...
@RestController
@RequestMapping("/recruiting/requirement")
@CrossOrigin
public class RequirmentsController {
	...
	public ResponseEntity<RestAPIResponse> deleteRequirmentByID(@PathVariable Long id) {
		...
		if (val == true) {
			...
			return new ResponseEntity<>(
					new RestAPIResponse("fail", "Submitted profile for the requirement ,Requirement Not Deleted", ""),
					HttpStatus.OK);
		}
	...
	public ResponseEntity<RestAPIResponse> saveRequirement(@RequestBody Requirements requirements) {
		...
		logger.info("!!! inside class : RecRequirmentsController, !! method : saveRequirement");
	...
	public ResponseEntity<RestAPIResponse> getrequirementNumber() {
		logger.info("!!! inside class : RecRequirmentsController, !! method : getAllRequirments");
		return new ResponseEntity<>(new RestAPIResponse("Success", "fetch All Requirments", service.findmaxReqNumber()),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<RestAPIResponse> getAssignedEmployees(@PathVariable Long id) {
		logger.info("!!! inside class : RecRequirmentsController, !! method : getAllRequirments");
		return new ResponseEntity<>(
				new RestAPIResponse("Success", "fetch All Requirments", service.getAssignedemploy(id)), HttpStatus.OK);
	}
	...
	public ResponseEntity<RestAPIResponse> getRequirmentByID(@PathVariable long id) {
		logger.info("!!! inside class : RecRequirmentsController, !! method : getRequirmentByID");
		return new ResponseEntity<>(
	...
	public ResponseEntity<RestAPIResponse> editRequirmentByID(@RequestBody Requirements requirements) {
		logger.info("!!! inside class : RecRequirmentsController, !! method : editRequirmentByID");
	...
	public ResponseEntity<RestAPIResponse> getAllRequirmentsByPageNo(@PathVariable("pageNo") int pageNo) {
		int pageSize = 2;
		logger.info("!!! inside class : RecRequirmentsController, !! method : getAllRequirmentsByPageNo");
